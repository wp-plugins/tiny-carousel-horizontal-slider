...
<div class="wrap">
    ...
    <table width="600" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td colspan="2"><input name="publish" lang="publish" class="button-primary" value="<?php echo @$submittext?>" type="submit" />
          <input name="publish" lang="publish" class="button-primary" onclick="tch_redirect()" value="Cancel" type="button" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <table width="100%" class="widefat" id="straymanage">
        ...
        <tbody>
          <tr class="<?php if ($i&1) { echo'alternate'; } else { echo ''; }?>">
            ...
            <td align="left" valign="middle">[TINY-CAROUSEL-SLIDER:<?php echo(stripslashes($data->tch_id)); ?>]</td>
  ...
  <br />
  Check official website for more details <a href="#" target="_blank">click here</a>
</div>
